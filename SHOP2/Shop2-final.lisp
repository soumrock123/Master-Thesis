...
; Operators
	...
	(:operator (!place-window ?window-type ?x ?y ?z)
		   ((clear ?x ?y ?z))
           	   ((clear ?x ?y ?z))
           	   ((block-at ?window-type ?x ?y ?z)))
...
; Methods
	...
	(:method (dig-eleven-xy ?x1 ?y0 ?z1 ?b)
		...
		(:ordered 
		  (!mine ?b ?x1 ?y0 ?z1) (!mine ?b ?x2 ?y0 ?z1) (!mine ?b ?x3 ?y0 ?z1)
		  (!mine ?b ?x4 ?y0 ?z1) (!mine ?b ?x5 ?y0 ?z1) (!mine ?b ?x6 ?y0 ?z1)
		  (!mine ?b ?x7 ?y0 ?z1) (!mine ?b ?x8 ?y0 ?z1) (!mine ?b ?x9 ?y0 ?z1)
		  (!mine ?b ?x10 ?y0 ?z1) (!mine ?b ?x11 ?y0 ?z1)))
		  
		  
		  
		  
	(:method (dig-nine-yz ?x1 ?y0 ?z2 ?b)
		((up ?y ?y0) (front ?z1 ?z)
		(front ?z2 ?z1) (front ?z3 ?z2) (front ?z4 ?z3) (front ?z5 ?z4) (front ?z6 ?z5)
		(front ?z7 ?z6) (front ?z8 ?z7) (front ?z9 ?z8) (front ?z10 ?z9))
		(:ordered 
		  (!mine ?b ?x1 ?y0 ?z2) (!mine ?b ?x1 ?y0 ?z3) (!mine ?b ?x1 ?y0 ?z4)
		  (!mine ?b ?x1 ?y0 ?z5) (!mine ?b ?x1 ?y0 ?z6) (!mine ?b ?x1 ?y0 ?z7)
		  (!mine ?b ?x1 ?y0 ?z8) (!mine ?b ?x1 ?y0 ?z9) (!mine ?b ?x1 ?y0 ?z10)))
	...
	(:method (fill-eleven-xy ?x1 ?y0 ?z1 ?d)
		...
		(:ordered 
		  (!place-block ?d ?x1 ?y0 ?z1) (!place-block ?d ?x2 ?y0 ?z1) (!place-block ?d ?x3 ?y0 ?z1)
		  (!place-block ?d ?x4 ?y0 ?z1) (!place-block ?d ?x5 ?y0 ?z1) (!place-block ?d ?x6 ?y0 ?z1)
		  (!place-block ?d ?x7 ?y0 ?z1) (!place-block ?d ?x8 ?y0 ?z1) (!place-block ?d ?x9 ?y0 ?z1)
		  (!place-block ?d ?x10 ?y0 ?z1) (!place-block ?d ?x11 ?y0 ?z1)))
	...
	(:method (fill-nine-yz ?x1 ?y0 ?z2 ?d)
		...
		(:ordered 
		  (!place-block ?d ?x1 ?y0 ?z2) (!place-block ?d ?x1 ?y0 ?z3) (!place-block ?d ?x1 ?y0 ?z4)
		  (!place-block ?d ?x1 ?y0 ?z5) (!place-block ?d ?x1 ?y0 ?z6) (!place-block ?d ?x1 ?y0 ?z7)
		  (!place-block ?d ?x1 ?y0 ?z8) (!place-block ?d ?x1 ?y0 ?z9) (!place-block ?d ?x1 ?y0 ?z10)))
	...
	(:method (house-wall-yz ?x3 ?y1 ?z6 ?i ?j ?w)
		...
		(:ordered 
		  ...
		  (build-block ?x3 ?y1 ?z7 ?j) (!place-window ?w ?x3 ?y2 ?z7) (build-block ?x3 ?y3 ?z7 ?j)
	...
	(:method (house-backwall ?x4 ?y1 ?z9 ?i ?w)
		...
		(:ordered 
		  ...
		  (build-block ?x5 ?y1 ?z9 ?i) (!place-window ?w ?x5 ?y2 ?z9) (build-block ?x5 ?y3 ?z9 ?i)
		  (build-block ?x6 ?y1 ?z9 ?i) (build-block ?x6 ?y2 ?z9 ?i) (build-block ?x6 ?y3 ?z9 ?i)
		  (build-block ?x7 ?y1 ?z9 ?i) (!place-window ?w ?x7 ?y2 ?z9) (build-block ?x7 ?y3 ?z9 ?i)
	...
	(:method (house-frontwall ?x4 ?y1 ?z5 ?i ?door ?w)
		...
		(:ordered 
		  ...
		  (build-block ?x5 ?y1 ?z5 ?i) (!place-window ?w ?x5 ?y2 ?z5) (build-block ?x5 ?y3 ?z5 ?i)
		  (build-block ?x6 ?y1 ?z5 ?i) (build-block ?x6 ?y2 ?z5 ?i) (build-block ?x6 ?y3 ?z5 ?i)
		  (!place-door ?door ?x7 ?y1 ?z5) (build-block ?x7 ?y3 ?z5 ?i)
	...
	(:method (build-custom-house ?x1 ?y ?y0 ?z1 ?b ?d ?e ?f ?g ?h ?i ?door ?w ?j ?k ?o ?t ?p)
		...
		(:ordered 
		  (dig-eleven-xy ?x1 ?y0 ?z1 ?b)
		  (dig-nine-yz ?x1 ?y0 ?z2 ?b)
		  (dig-nine-yz ?x11 ?y0 ?z2 ?b)
		  (dig-eleven-xy ?x1 ?y0 ?z11 ?b)
...
(defproblem final final-house
	...
	((build-custom-house 1 0 -1 1 grass oak-wood spruce-wood-planks spruce-wood-slab spruce-wood-stairs bricks oak-wood-planks oak-door 	 	glass-pane oak-wood-stairs oak-leaves oak-fence torch wooden-pressure-plate)))
